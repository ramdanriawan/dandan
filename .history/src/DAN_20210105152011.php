...
// $dan = new DAN('localhost', 'root', '', 'databases_2020_2021_putra_pengolahan_data_rehabilitas');
// print_r($dan->data_admin('username', 'putra'));

// foreach($dan->data_pemesanan() as $data_pemesanan) 
// {

//     print_r( $dan->data_ruangan($data_pemesanan->id_ruangan));
// }