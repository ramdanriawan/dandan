...
class Model extends Connection
{
    ...
    {
        foreach($this->getRelation() as $table) {

        }
        $model = clone $this;
        $model->setTable($table)->setLoop()->setAttributes();
    }

    public function getRelation($table = null)
    {
        if($table) {

            return parent::getRelations()[$this->table][$table];    
        }
