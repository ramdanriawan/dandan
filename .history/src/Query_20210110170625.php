        ...
        foreach($models as $index => $model) {
            foreach(parent::getRelation() as $relationName => $relationSetting) 
            {
                ...
                if($relationSetting['relation_name'] == 'belongstoone') {
                    ...
                    $models[$index]->$relationName = $relation->where($relationSetting['column'], $this->{$this->primaryKey});
                } else if($relationSetting['relation_name'] == 'hastoone') {echo($this->{$this->primaryKey});
                    $models[$index]->$relationName = $relation->row($relationSetting['column'], $this->{$this->primaryKey});
                }
            }
        }
